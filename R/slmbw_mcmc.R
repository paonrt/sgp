#' @title Spatial Linear Regression Modeling Binomial and Weibull Distributions
...
slmbw_mcmc = function(
  ...
  if (!is.infinite(verbose)) {
    print(paste("slmbw_mcmc: start time at ", Sys.time(), sep = ""))
  }
  ...
  if (!is.infinite(verbose)) {
    print(paste("slmbw_mcmc: end time at ", Sys.time(), sep = ""))
  }
